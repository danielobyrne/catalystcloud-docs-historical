...
them for a week or anything less than 24/7 you are not getting the most out of
your monthly bill. On a cloud based system you only pay for what is used and
you can change your resources on the fly. If you need to horizontally scale an
instance you can simply spin up more compute nodes. If you need to increase the
size of your block storage, then you can add a new volume to your instance. Or
you can use our object storage service, which scales dynamically, as an
alternative. 

In a cloud environment your instances and other resources are scheduled by the
cloud and you are only billed for the amount of resources you use and for how
...
This also opens up interesting avanues to save money as you can shelve 
instances when they are not in use to save on your monthly bill (as you are only
charge while an instance is active)
